...
private Color CLR;
    ...
    private void initComponents() {
        ...
        setTitle("Ejemplo JAVA");

        jLabel2.setFont(new java.awt.Font("Comic Sans MS", 1, 14)); // NOI18N
        jLabel2.setText("Seleccionar Tipo");

        cbxSELECCION.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
        cbxSELECCION.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Números naturales", "Números primos", "Números aleatorios", "Números pares", "Números impares" }));
            ...
            if (OBJ.EsCadenaNumerica(SS)){
                if (SS.length()<=5) {
                    ...
                    switch (cbxSELECCION.getSelectedIndex()) {
                        case 0 -> GenerarNumerosNaturales();
                        case 1 -> GenerarNumerosPrimos();
                        case 2 -> GenerarNumerosAleatorios();
